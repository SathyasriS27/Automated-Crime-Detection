...
import com.openlab.homodex.TFLiteFaceRecognition.customview.OverlayView;
import com.openlab.homodex.TFLiteFaceRecognition.env.BorderedText;
import com.openlab.homodex.TFLiteFaceRecognition.env.ImageUtils;
import com.openlab.homodex.TFLiteFaceRecognition.env.Logger;
import com.openlab.homodex.TFLiteFaceRecognition.tflite.TFLiteObjectDetectionAPIModel;
import com.openlab.homodex.TFLiteFaceRecognition.tracking.MultiBoxTracker;
...
//  //private static final String TF_OD_API_MODEL_FILE = "facenet_hiroki.tflite";
  ...
  public void onPreviewSizeChosen(final Size size, final int rotation) {
    ...
    try {
      ...
      Toast.makeText(this, "Classifier couldn't be initialized.", Toast.LENGTH_SHORT).show();
      finish();
    }
...
//                    sensorOrientation, MAINTAIN_ASPECT);
  ...
  protected int getLayoutId() {
    return R.layout.recognize_connection_fragment;
  }
  ...
  private void updateResults(long currTimestamp, final List<SimilarityClassifier.Recognition> mappedRecognitions) {
    ...
    if (mappedRecognitions.size() > 0) {
       ...
       if (rec.getExtra() != null) {
         Toast.makeText(this, "This face doesn't exist in our database.", Toast.LENGTH_SHORT).show();
